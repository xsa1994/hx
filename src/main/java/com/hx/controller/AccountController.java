...
public class AccountController {
    ...
    public PageResult<Account> pageQuery(@ModelAttribute @RequestParam Integer currentPage, @ModelAttribute @RequestParam Integer pageSize) throws HxException {
        if (currentPage == null) {
    ...
    public Account queryById(@ModelAttribute @RequestParam Long id) throws HxException {
        if (id == null) {
